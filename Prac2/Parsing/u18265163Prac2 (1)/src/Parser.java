...
class Parser{
    ...
    private Boolean parseSEQ(Node parent){
        if(tokens.get(index).getContent() == ";"){
            ...
            index++;
            if(index >= tokens.size()){
                System.out.println("\u001B[31mError\u001B[0m: invalid instruction at line "+ tokens.get(index-1).getRow() + " col "+ tokens.get(index-1).getCol() + ", unexpected \';\' token");
                System.exit(0);
                return false;
            }
    ...
    private Boolean parseBOOLVAR(Node parent){
        ...
        if(tokens.get(index).getContent() == "b"){
            ...
            System.out.println("\u001B[31mError\u001B[0m: invalid token at line "+ tokens.get(index).getRow() + " col "+ tokens.get(index).getCol() + ", expected \'"+ "b" + "\' token");
            System.exit(0);
            // parser failed
            return false;
        }
    ...
    private Boolean parseSTRINGV(Node parent){
        ...
        if(tokens.get(index).getContent() == "s"){
            ...
            System.out.println("\u001B[31mError\u001B[0m: invalid token at line "+ tokens.get(index).getRow() + " col "+ tokens.get(index).getCol() + ", expected \'"+ "s" + "\' token");
            System.exit(0);
            // parser failed
            return false;
        }
    ...
    private Boolean parseNUMEXPR(Node parent){
        ...
        if(tokens.get(index).getContent() == "a" || tokens.get(index).getContent() == "m" || tokens.get(index).getContent() == "d"){
            ...
            System.out.println("\u001B[31mError\u001B[0m: invalid token at line "+ tokens.get(index).getRow() + " col "+ tokens.get(index).getCol() + ", expected \'"+ "valid" + "\' token");
            System.exit(0);
            // parser failed
            return false;
        }
    ...
    private Boolean parseBOOLEXPR(Node parent){
        ...
        if(tokens.get(index).getContent() == "b" || tokens.get(index).getContent() == "T" || tokens.get(index).getContent() == "F" || tokens.get(index).getContent() == "^" || tokens.get(index).getContent() == "v" || tokens.get(index).getContent() == "!" ){
            ...
            System.out.println("\u001B[31mError\u001B[0m: invalid token at line "+ tokens.get(index).getRow() + " col "+ tokens.get(index).getCol() + ", expected \'"+ "a valid" + "\' token");
            System.exit(0);  
            // parser failed
            return false;
        }
    ...
    private Boolean parseDIGITS(Node parent){
        ...
        if(isDigit(tokens.get(index).getContent())){
            ...
            if(d){
                ...
                if(isDigit(tokens.get(index).getContent()) ){
                   Boolean more = parseMORE(digitsNode);
                    ...
                    System.out.println("\u001B[31mError\u001B[0m: invalid token at line "+ tokens.get(index).getRow() + " col "+ tokens.get(index).getCol() + ", expected \'"+ "a digit or a valid symbol" + "\' token");
                    System.exit(0);
                    // parser failed
                    return false;
                }
            ...
            System.out.println("\u001B[31mError\u001B[0m: invalid token at line "+ tokens.get(index).getRow() + " col "+ tokens.get(index).getCol() + ", expected \'"+ "a digit" + "\' token");
            System.exit(0);
            // parser failed
            return false;
        }
    ...
    private Boolean parseELSE(Node parent){
        ...
        if(tokens.get(index).getContent() == "e"){
            ...
            index++;
            if(index >= tokens.size()){
                System.out.println("\u001B[31mError\u001B[0m: invalid else instruction at line "+ tokens.get(index-1).getRow() + " col "+ tokens.get(index-1).getCol());
                System.exit(0);
                return false;
            }
            if(tokens.get(index).getContent() == "{"){
                ...
                if(algo){
                    if(index >= tokens.size()){
                        System.out.println("\u001B[31mError\u001B[0m: invalid else instruction at line "+ tokens.get(index-1).getRow() + " col "+ tokens.get(index-1).getCol()+ "missing '}'' token");
                        System.exit(0);
                        return false;
                    }
                    if(tokens.get(index).getContent() == "}"){
    ...
    private Boolean parseDECNUM(Node parent){
        ...
        if(tokens.get(index).getContent() == "0.00"){
           ...
           Boolean neg = parseNEG(decnumNode);
            ...
            System.out.println("\u001B[31mError\u001B[0m: invalid token at line "+ tokens.get(index).getRow() + " col "+ tokens.get(index).getCol() + ", expected \'"+ "a valid token" + "\' token");
            System.exit(0);
            // parser failed
            return false;
        }
